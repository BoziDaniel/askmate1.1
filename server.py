...
# @app.route('/delete_comment/are_you_sure/<comment_id>/<question_id>')
# def route_are_you_sure(comment_id, question_id):
#     return render_template('are_you_sure.html', comment_id=comment_id, question_id=question_id)
